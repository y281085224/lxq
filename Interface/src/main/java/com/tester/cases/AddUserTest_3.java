...
//该用例是从com.tester.model.AddData中获取的内容，
public class AddUserTest_3 {
    ...
    public void addUser() throws IOException, InterruptedException {
        ...
        AddData addUserCase = new AddData();

        System.out.println(TestConfig.addUserUrl);

        List<User> expectedList = session.selectList("addDataUser", addUserCase);
        ...
        List<User> actualList = session.selectList("addDataUser", addUserCase);//把插入的内容当做查询条件，查询内容
    ...
    private int getResult(AddData addUserCase) throws IOException {
